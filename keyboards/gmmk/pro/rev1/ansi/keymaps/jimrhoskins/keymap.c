...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [1] = LAYOUT(
        ...
        _______, RGB_TOG, RGB_M_P, RGB_M_B, RGB_M_SW, RGB_M_SN, RGB_M_K, RGB_M_K, RGB_M_X, RGB_M_G, RGB_M_T, _______, _______, _______,            _______,
        _______, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI,  _______,  _______, _______, _______, _______, _______, _______, _______, QK_BOOT,            _______,
        ...
        _______, AG_NORM, AG_SWAP,                              _______,                            _______, _______, _______, RGB_SPD, RGB_RMOD,  RGB_SPI
    ),
